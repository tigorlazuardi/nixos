{ lib, ... }:
{
  # https://old.reddit.com/r/neovim/comments/1ir069p/treesitter_diagnostics/
  programs.nixvim.extraConfigLua =
    lib.mkIf false # Requires nightly neovim. We are using stable. But we keep it here for future reference.
      # lua
      ''
        do
